...
import { Box, Ellipsis, LogOutIcon, Printer, Star } from "lucide-react";
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  size="icon"
                  className="rounded-full bg-default-100 hover:text-default-50 hover:outline-0 hover:outline-offset-0  hover:border-0 hover:ring-0 text-default-600 hover:ring-offset-0 p-4 cursor-pointer"
                >
        ...
        <div className="py-5 flex gap-5 flex-wrap items-center border-b border-solid border-default-200">
          <div className="flex flex-col items-center">
            <Image
              ...
              alt="mail"
            />
            <Link className="text-primary mt-1" href="/">
              Download
            </Link>
          </div>
          <div className="flex flex-col items-center">
