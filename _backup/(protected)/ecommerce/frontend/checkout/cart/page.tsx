                    ...
                    items?.map((item, i) => (
                      <tr key={i}>
                        ...
                        <td className=" px-3 py-3">
                          <div className="flex-1 h-8 w-[110px] flex border border-default-900 delay-150 ease-in-out  divide-x-[1px] rtl:divide-x-reverse text-sm font-normal divide-default-900  rounded">
                            <button className="md:px-3 px-2 disabled:cursor-not-allowed cursor-pointer">
                        ...
                        <td className=" text-right  px-6 py-3">
                          <button className="bg-default-100 text-default-400 p-2.5 transition-all  mb-1.5 rounded-full hover:bg-destructive/20   hover:text-destructive duration-200 cursor-pointer">
