...
import { AttendeeRegistrationQuotaFormSheet } from "@/components/admin/exhibitor/AttendeeRegistrationQuotaFormSheet";
...
export default function AttendeeRegistrationQuotaPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage attendee registration quotas (Conference) for Event #
            {eventId}
          </p>
        </div>
        <CreateButton
          label="Attendee Registration Quota"
          onClick={() => {
            setEditingQuota(null);
            setIsFormOpen(true);
          }}
      ...
      <AttendeeRegistrationQuotaFormSheet
        open={isFormOpen}
