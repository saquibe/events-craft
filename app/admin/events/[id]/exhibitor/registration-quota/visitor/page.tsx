...
import { VisitorRegistrationQuotaFormSheet } from "@/components/admin/exhibitor/VisitorRegistrationQuotaFormSheet";
...
export default function VisitorRegistrationQuotaPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage visitor registration quotas (Free/Exhibition) for Event #
            {eventId}
          </p>
        </div>
        <CreateButton
          label="Add Visitor Registration"
          onClick={() => {
            setEditingQuota(null);
            setIsFormOpen(true);
          }}
      ...
      <VisitorRegistrationQuotaFormSheet
        open={isFormOpen}
