...
interface AttendeeRegistrationQuotaFormSheetProps {
  open: boolean;
...
export function AttendeeRegistrationQuotaFormSheet({
  open,
  onOpenChange,
  quota,
  exhibitors,
  onSubmit,
  isSubmitting = false,
}: AttendeeRegistrationQuotaFormSheetProps) {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-xl">
        <SheetHeader>
          <SheetTitle>
            {quota
              ? "Edit Attendee Registration Quota"
              : "Add Attendee Registration Quota"}
          </SheetTitle>
          <SheetDescription>
            {quota
              ? "Update the attendee registration quota information"
              : "Add a new attendee registration quota (Conference)"}
          </SheetDescription>
        </SheetHeader>
