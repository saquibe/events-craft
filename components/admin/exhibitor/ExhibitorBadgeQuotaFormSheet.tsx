...
interface ExhibitorBadgeQuotaFormSheetProps {
  open: boolean;
...
export function ExhibitorBadgeQuotaFormSheet({
  open,
  onOpenChange,
  quota,
  exhibitors,
  onSubmit,
  isSubmitting = false,
}: ExhibitorBadgeQuotaFormSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-xl">
        <SheetHeader>
          <SheetTitle>
            {quota ? "Edit Exhibitor Badge Quota" : "Add Exhibitor Badge Quota"}
          </SheetTitle>
          <SheetDescription>
            {quota
              ? "Update the exhibitor badge quota information"
              : "Add a new exhibitor badge quota"}
          </SheetDescription>
        </SheetHeader>
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Exhibitor Badge Quota *</FormLabel>
                  <FormControl>
